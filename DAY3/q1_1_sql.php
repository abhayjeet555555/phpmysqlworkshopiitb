...
echo"<br>";
    ...
    echo "Subject1=$b";echo"<br>";echo "Subject2=$c";echo"<br>";echo "subject3=$d";echo"<br>";
   ...
   echo "<h2>TOTAL MARKS OBTAINED</h2>";
    ...
    if($conn->connect_error){
        ...
        $stmt= $conn->prepare("insert into class1(name, subject1, subject2, subject3, subject4, subject5, totalmarks, percentage) 
        values( ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("siiiiiii",$a,$b,$c,$d,$e,$f,$m,$p);
        $stmt->execute();
